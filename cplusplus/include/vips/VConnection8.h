...
public:
	 ...
	 */
	VSource(VipsSource *input, VSteal steal = STEAL) : VObject((VipsObject *) input, steal)
	{
	}
...
public:
	 ...
	 */
	VTarget(VipsTarget *output, VSteal steal = STEAL) : VObject((VipsObject *) output, steal)
	{
	}
