 ...
 * @VIPS_FOREIGN_PRESERVE_PHOTOSHOP: preserve TIFFTAG_PHOTOSHOP
 * @VIPS_FOREIGN_PRESERVE_IMAGEDESCRIPTION: preserve TIFFTAG_IMAGEDESCRIPTION
...
typedef enum /*< flags >*/ {
	...
	VIPS_FOREIGN_PRESERVE_PHOTOSHOP = 1 << 4,
	VIPS_FOREIGN_PRESERVE_IMAGEDESCRIPTION = 1 << 5,
	...
	VIPS_FOREIGN_PRESERVE_ALL = (VIPS_FOREIGN_PRESERVE_EXIF |
		...
		VIPS_FOREIGN_PRESERVE_PHOTOSHOP |
		VIPS_FOREIGN_PRESERVE_IMAGEDESCRIPTION),
} VipsForeignPreserve;
