...
GIF_ANIM_DISPOSE_BACKGROUND2_FILE = os.path.join(IMAGES, "dispose-background2.gif")
GIF_ANIM_DISPOSE_BACKGROUND2_EXPECTED_PNG_FILE = os.path.join(IMAGES, "dispose-background2.png")
GIF_ANIM_MICKEY_FILE = os.path.join(IMAGES, "mickey.gif")
GIF_ANIM_MICKEY_EXPECTED_PNG_FILE = os.path.join(IMAGES, "mickey.png")
GIF_ANIM_3_FILE = os.path.join(IMAGES, "3.gif")
GIF_ANIM_3_EXPECTED_PNG_FILE = os.path.join(IMAGES, "3.png")
