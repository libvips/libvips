...
static VipsObjectClass *vips_interpolate_bilinear_slow_parent_class = NULL;
static VipsObjectClass *vips_interpolate_yafr_parent_class = NULL;
	...
	int out_x, int out_y, double in_x, double in_y )
{
	VipsInterpolateBilinearSlow *bilinear_slow = 
		VIPS_INTERPOLATE_BILINEAR_SLOW( interpolate );
	VipsInterpolateBilinearSlowClass *class = 
		VIPS_INTERPOLATE_BILINEAR_SLOW_GET_CLASS( interpolate );
